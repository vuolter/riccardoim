...
}.call(exports, __webpack_require__(14), (function () { return this; }()), __webpack_require__(15)(module)))
		...
		var AllProjects = function () {
			...
			_createClass(AllProjects, [{
				...
				value: function showProjects(target) {
					...
					(0, _promiseAjax.httpGet)('recensioni/tutte/', target).then(function (data) {
